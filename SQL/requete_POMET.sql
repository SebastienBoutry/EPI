...
nt, pt, espece.nom, espece.nom_fr, engin, masse_eau.masse_eau, salinite_classe, systeme
...
campagnes.fk_masse_eau = masse_eau.masse_eau_id AND
espece.subphylum = 'Vertebrata';
